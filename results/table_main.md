...
what `scripts/checks/check_table_main.py` re-derives against.
...
spreads are in Additional file 1, Table S7.
...
> Row 8 is not a row here. It is a within-stratum concordance over restricted pairs, a different estimand from a record-level AUROC, and it has its own panel in Additional file 1, Table S1.
...
|---|---|---|---|---|
| G1: R3_acqctx_pre beats R2_demo | Mortality, 365d | positive, beyond the 0.0043 seed and noise spread | -0.0216 [-0.0523, +0.0098] | FAILED |
...
|---|---|---|
| ICU admission, 24h | `R9_triage`, triage acuity alone | 0.7583 [0.7410, 0.7755] |
...
| Mortality, 28d | `R9_triage`, triage acuity alone | 0.7120 [0.6757, 0.7480] |
...
| Mortality, 365d | `R9_triage`, triage acuity alone | 0.6298 [0.6095, 0.6502] |
...
|---|---|---|---|---|---|
| `R3_acqctx_pre - R2_demo` | ICU admission, 24h | <0.0002 | <0.0002 | P3 | 15 |
| `R3_acqctx_pre - R6_waveform` | Mortality, 28d | <0.0002 | <0.0002 | P3 | 15 |
| `R3_acqctx_pre - R6_waveform` | Mortality, 365d | <0.0002 | <0.0002 | P3 | 15 |
| `R7_waveform_demo_acq - R6_waveform` | ICU admission, 24h | <0.0002 | <0.0002 | P3 | 15 |
| `R7_waveform_demo_acq - R6_waveform` | Mortality, 28d | <0.0002 | <0.0002 | P3 | 15 |
| `R7_waveform_demo_acq - R6_waveform` | Mortality, 365d | <0.0002 | <0.0002 | P3 | 15 |
| `R8_waveform_matched - R6_waveform` | ICU admission, 24h | <0.0002 | <0.0002 | P4 | 15 |
| `R8_waveform_matched - R6_waveform` | Mortality, 28d | <0.0002 | <0.0002 | P4 | 15 |
| `R8_waveform_matched - R6_waveform` | Mortality, 365d | <0.0002 | <0.0002 | P4 | 15 |
| `R3_acqctx_pre - R2_demo` | Mortality, 28d | 0.0108 | 0.0648 | P3 | 15 |
| `R4_demo_acq - R6_waveform` | Mortality, 28d | 0.0128 | 0.0648 | P3 | 15 |
| `R4_demo_acq - R6_waveform` | Mortality, 365d | 0.0152 | 0.0648 | P3 | 15 |
| `R3_acqctx_pre - R6_waveform` | ICU admission, 24h | 0.0478 | 0.1434 | P3 | 15 |
| `R3_acqctx_pre - R2_demo` | Mortality, 365d | 0.177 | 0.354 | P3 | 15 |
| `R4_demo_acq - R6_waveform` | ICU admission, 24h | 0.4368 | 0.4368 | P3 | 15 |
...
|---|---|---|---|---|---|---|
| `R3_acqctx_pre - R2_demo` | ICU admission, 24h | +0.1955 [+0.1649, +0.2267] | <0.0002 | 0.0049 | yes | P3 |
| `R3_acqctx_pre - R6_waveform` | Mortality, 28d | -0.0886 [-0.1246, -0.0544] | <0.0002 | 0.0207 | yes | P3 |
| `R3_acqctx_pre - R6_waveform` | Mortality, 365d | -0.1053 [-0.1301, -0.0809] | <0.0002 | 0.0130 | yes | P3 |
| `R7_waveform_demo_acq - R6_waveform` | ICU admission, 24h | +0.0398 [+0.0298, +0.0498] | <0.0002 | 0.0091 | yes | P3 |
| `R7_waveform_demo_acq - R6_waveform` | Mortality, 28d | +0.0250 [+0.0128, +0.0374] | <0.0002 | 0.0190 | yes | P3 |
| `R7_waveform_demo_acq - R6_waveform` | Mortality, 365d | +0.0239 [+0.0155, +0.0324] | <0.0002 | 0.0130 | yes | P3 |
| `R8_waveform_matched - R6_waveform` | ICU admission, 24h | -0.0688 [-0.0912, -0.0478] | <0.0002 | - | - | P4 |
| `R8_waveform_matched - R6_waveform` | Mortality, 28d | -0.0680 [-0.1102, -0.0284] | <0.0002 | - | - | P4 |
| `R8_waveform_matched - R6_waveform` | Mortality, 365d | -0.0318 [-0.0488, -0.0157] | <0.0002 | - | - | P4 |
| `R3_acqctx_pre - R2_demo` | Mortality, 28d | +0.0624 [+0.0165, +0.1082] | 0.0648 | 0.0207 | yes | P3 |
| `R4_demo_acq - R6_waveform` | Mortality, 28d | -0.0371 [-0.0684, -0.0077] | 0.0648 | 0.0190 | yes | P3 |
| `R4_demo_acq - R6_waveform` | Mortality, 365d | -0.0261 [-0.0481, -0.0049] | 0.0648 | 0.0130 | yes | P3 |
| `R3_acqctx_pre - R6_waveform` | ICU admission, 24h | -0.0201 [-0.0406, -0.0002] | 0.1434 | 0.0091 | yes | P3 |
| `R3_acqctx_pre - R2_demo` | Mortality, 365d | -0.0216 [-0.0523, +0.0098] | 0.354 | 0.0043 | yes | P3 |
| `R4_demo_acq - R6_waveform` | ICU admission, 24h | -0.0080 [-0.0276, +0.0115] | 0.4368 | 0.0091 | no | P3 |
...
> This family is corrected separately from the audit family (Additional file 1, Table S4) and the two are never pooled. No test carries an adjusted p in both.
